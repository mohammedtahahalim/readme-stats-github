...
import { content } from "../langs/langData";
import { getDir } from "./getDir";

export default function template(data: GetData, uiConfig: UiConfig): string {
  const { lang, text_color, border_color, card_color, icon_color } = uiConfig;
  const {
    followers,
    totalRepo,
    starCount,
  ...
  var card = `<svg width="495" height="195" dir=${getDir(lang)} viewBox="0 0 495 195" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <rect x="0.5" y="0.5" rx="4.5" height="99%" width="494" fill="#${card_color}" stroke="#${border_color}" stroke-opacity="1" />
    ...
    <circle cx="86" cy="44" r="40" stroke="#${card_color}" stroke-width="3" fill="url(#image)" />
        ...
        <text x="140" y="124" style="font-weight: 700" class="followers">${data.followers}</text>
        ...
        <svg>
            <g transform="translate(230, 0)">
                <g class="singleitem" style="animation-delay: 210ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="25" y="12.5">${totalRepo}</text>
            ...
            <g transform="translate(230, 25)">
                <g class="singleitem" style="animation-delay: 350ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="25" y="12.5">${starCount}</text>
                    <text class="text" style="font-weight: 700" x="175" y="12.5">${data.total_stars}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 50)">
                <g class="singleitem" style="animation-delay: 460ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="25" y="12.5">${forkCount}</text>
                    <text class="text" style="font-weight: 700" x="175" y="12.5">${data.total_forks}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 75)">
                <g class="singleitem" style="animation-delay: 560ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="25" y="12.5">${contribution}</text>
            ...
            <g transform="translate(230, 100)">
                <g class="singleitem" style="animation-delay: 660ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="25" y="12.5">${totalIssues}</text>
                    <text class="text" style="font-weight: 700" x="175" y="12.5">${data.total_issues}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 125)">
                <g class="singleitem" style="animation-delay: 760ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="25" y="12.5">${closedIssues}</text>
                    <text class="text" style="font-weight: 700" x="175" y="12.5">${data.total_closed_issues}</text>
                </g>
            </g>
